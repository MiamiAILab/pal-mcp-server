...
# Each provider (gemini.py, openai.py, xai.py, custom.py, minimax.py, moonshot.py, zhipu.py, together.py)
...
# conversation history, or content sent to external models (Gemini/OpenAI/X.AI).
#
